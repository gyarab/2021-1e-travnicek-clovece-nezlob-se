...
public class HelloApplication extends Application {
    ...
    private final Button b57 = new Button("Dice");
    ...
    private void rollTheDice(MouseEvent e) {
        ...
        if (lastColor == (Color.RED)) {
            ...
            if (yellowPlayerDistance == 36 && yellowHouse.getTokens()>= 1) {
                yellowHouse.getOneToken();
                yellowPlayerDistance = 0;

            }

            if(yellowHouse.getTokens() == 0 && yellowPlayerDistance==36){
                Alert yellowAlert = new Alert(Alert.AlertType.INFORMATION, "YELLOW WIN!");
                yellowAlert.showAndWait();
                Platform.exit();
            }
            ...
            if (greenPlayerDistance == 36 && greenHouse.getTokens()>= 1) {
                greenHouse.getOneToken();
                greenPlayerDistance = 0;

            }

            if(greenHouse.getTokens() == 0 && greenPlayerDistance==36){
                Alert greenAlert = new Alert(Alert.AlertType.INFORMATION, "GREEN WIN!");
                greenAlert.showAndWait();
                Platform.exit();
            }
            ...
            if (bluePlayerDistance == 36 && blueHouse.getTokens()>= 1) {
                blueHouse.getOneToken();
                bluePlayerDistance = 0;

            }

            if(blueHouse.getTokens() == 0 && bluePlayerDistance==36){
                Alert blueAlert = new Alert(Alert.AlertType.INFORMATION, "BLUE WIN!");
                blueAlert.showAndWait();
                Platform.exit();
            }
            ...
            lastColor = Color.RED;
            if (redPlayerDistance == 36 && redHouse.getTokens()>= 1) {
                redHouse.getOneToken();
                redPlayerDistance = 0;
            }

            if(redHouse.getTokens() == 0 && redPlayerDistance==36){
                Alert redAlert = new Alert(Alert.AlertType.INFORMATION, "RED WIN!");
